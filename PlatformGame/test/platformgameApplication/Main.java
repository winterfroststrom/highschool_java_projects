...
package platformgameAppliction;
...
public class Main extends JFrame{
    ...
    private World all  = new World(this);
    ...
    public void loadImages(){
        try{
            ...
            buff[0] = ImageIO.read(new File("bin\\you.png"));
            buff[1] = ImageIO.read(new File("bin\\youleft.png"));
            buff[2] = ImageIO.read(new File("bin\\youright.png"));
            buff[3] = ImageIO.read(new File("bin\\wall.png"));
            buff[4] = ImageIO.read(new File("bin\\enemy.png"));
            buff[5] = ImageIO.read(new File("bin\\enemy2.png"));
            buff[6] = ImageIO.read(new File("bin\\enemy3.png"));
            buff[7] = ImageIO.read(new File("bin\\fire1.png"));
            buff[8] = ImageIO.read(new File("bin\\fire3.png"));
            buff[9] = ImageIO.read(new File("bin\\fire4.png"));
            buff[10] = ImageIO.read(new File("bin\\fire5.png"));
            buff[11] = ImageIO.read(new File("bin\\border.png"));
            buff[12] = ImageIO.read(new File("bin\\rock.png"));
            buff[13] = ImageIO.read(new File("bin\\icon1.png"));
            buff[14] = ImageIO.read(new File("bin\\icon2.png"));
            buff[15] = ImageIO.read(new File("bin\\icon3.png"));
            buff[16] = ImageIO.read(new File("bin\\icon4.png"));
            buff[17] = ImageIO.read(new File("bin\\icon5.png"));
            buff[18] = ImageIO.read(new File("bin\\fire2.png"));
            buff[19] = ImageIO.read(new File("bin\\powerup1.png"));
            buff[20] = ImageIO.read(new File("bin\\powerup2.png"));
            buff[21] = ImageIO.read(new File("bin\\powerup3.png"));
            buff[22] = ImageIO.read(new File("bin\\powerup4.png"));
            buff[23] = ImageIO.read(new File("bin\\powerup5.png"));
            buff[24] = ImageIO.read(new File("bin\\explosion.png"));
            buff[25] = ImageIO.read(new File("bin\\explosion2.png"));
            buff[26] = ImageIO.read(new File("bin\\explosion3.png"));
            buff[27] = ImageIO.read(new File("bin\\boss.png"));
            buff[28] = ImageIO.read(new File("bin\\boss2.png"));
            buff[29] = ImageIO.read(new File("bin\\boss3.png"));
    ...
    private abstract class Craft extends RecObj implements Tangible,Drawable{
        ...
        public boolean notInBounds(){
            if(this.construct().intersects(-100, -100, 700, 600))
                return false;
            return true;
        }
    ...
    private class World extends JPanel{
        ...
        public void end(Graphics2D g){
            ...
            Font end = new Font("Dialog",Font.BOLD,50);
            g.setFont(end);
            if(player.isDead()){
        ...
        public void keyReleased(KeyEvent e){
            ...
            switch(action){
                ...
                case KeyEvent.VK_0: base.clearAll();
                    break;
                case KeyEvent.VK_P: base.notOver = !base.notOver;
                    break;
            }
    ...
    private class DWall extends BorderWall{
        public DWall(Main base){
            super(new Point(0,470),500,3,base);
        }
    }
...
/*
    private abstract class MObj implements Collidable{
        public int lr;
        public int ud;
        public int speed;
        public Point p;
        ...
        public MObj(int x, int y){
            p = new Point(x,y);
        }

        public MObj(int x, int y, int speed){
            p = new Point(x,y);
            this.speed = speed;
        }
    ...
    private class CirObj extends MObj{
        public int size;

        public CirObj(int x, int y, int size){
            super(x,y);
            this.size = size;
        }

        public CirObj(int x, int y, int speed, int size){
            super(x,y,speed);
            this.size = size;
        }

        public CirObj(Point p, int size){
            super(p);
            this.size = size;
        }

        public CirObj(Point p, int speed, int size){
            super(p,speed);
            this.size = size;
        }
        ...
        public Ellipse2D.Double construct(){
            return new Ellipse2D.Double(x - Math.floor(size+.5)/2 ,
                    y - Math.floor(size+.5)/2 , size , size);
        }

        public boolean collide(MObj o){
            if(o.type() == 1){
               return distance(o,this) < Math.pow((((CirObj)o).size + size)/2, 2);
            } else{
